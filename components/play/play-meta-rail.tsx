    ...
    <div className="grid gap-4">
      <Card className="rounded-[1.8rem] border-white/8 bg-[#111118]/88 p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-accent">Play info</p>
            <h2 className="mt-2 font-display text-[1.8rem] tracking-[-0.04em] text-foreground">플레이 정보</h2>
          </div>
      ...
      <Card className="rounded-[1.8rem] border-white/8 bg-white/[0.03] p-5">
        <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-accent">Controls</p>

...
- 개인정보처리방침: `https://iis-arcade-portal.jeonsavvy.workers.dev/privacy`

운영 smoke check는 홈, 개인정보처리방침, 공개 플레이 화면, 로그인 리다이렉트, `/api/auth/me`, 비로그인 계정 탈퇴 API의 401 응답, artifact proxy의 정상/비정상 응답을 확인합니다.
